...
public class Testing {
    ...
    public static void testAccountHistory() {
        AccountHistory pp = new AccountHistory(10);
        pp.append(new AccountTransaction(TransactionType.OPEN, new BigDecimal(0)));
        pp.append(new AccountTransaction(TransactionType.DEPOSIT, new BigDecimal(1000)));
        pp.append(new AccountTransaction(TransactionType.WITHDRAW, new BigDecimal(200)));
        pp.append(new AccountTransaction(TransactionType.TRANSFER_OUT, new BigDecimal(1000)));
        pp.append(new AccountTransaction(TransactionType.TRANSFER_IN, new BigDecimal(300)));
